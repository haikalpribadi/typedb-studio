...
class File internal constructor(
    ...
    private class Callbacks {
        ...
        val onWatch = LinkedBlockingDeque<(File) -> Unit>()
        ...
        fun clone(): Callbacks {
            ...
            newCallbacks.onWatch.addAll(this.onWatch)
    ...
    override fun onWatch(function: (Resource) -> Unit) {
        callbacks.onWatch.push(function)
    }
    ...
    override fun launchWatcher() {
        callbacks.onWatch.forEach { it(this) }
